...
class SubtasksHandlerTest {
    ...
    void handleEndpoint_GetAllSubtasks() throws IOException {
        ...
        when(mockTaskManager.getAllSubtask()).thenReturn(List.of(subTask1, subTask2));

        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        when(mockExchange.getResponseBody()).thenReturn(outputStream);

        subtasksHandler.handleEndpoint(mockExchange, Endpoint.GET_ALL, new String[]{"subtasks"});
    ...
    void handleEndpoint_GetSubtaskById() throws IOException {
        ...
        when(mockExchange.getRequestMethod()).thenReturn("GET");
        when(mockExchange.getRequestURI()).thenReturn(URI.create("/subtasks/1"));
        ...
        subtasksHandler.handleEndpoint(mockExchange, Endpoint.GET, new String[]{"subtasks", "1"});
    ...
    void handleEndpoint_PostCreateSubtask() throws IOException {
        ...
        when(mockTaskManager.createSubTask(any(SubTask.class))).thenReturn(createdSubTask);

        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        when(mockExchange.getResponseBody()).thenReturn(outputStream);

        subtasksHandler.handleEndpoint(mockExchange, Endpoint.POST, new String[]{"subtasks"});
    ...
    void handleEndpoint_PostUpdateSubtask() throws IOException {
        ...
        when(mockTaskManager.updateSubTask(any(SubTask.class))).thenReturn(updatedSubTask);
    ...
    void handleEndpoint_DeleteAllSubtasks() throws IOException {
        ...
        subtasksHandler.handleEndpoint(mockExchange, Endpoint.DELETE_ALL, new String[]{"subtasks"});
    ...
    void handleEndpoint_DeleteSubtaskById() throws IOException {
        ...
        subtasksHandler.handleEndpoint(mockExchange, Endpoint.DELETE, new String[]{"subtasks", "1"});
    ...
    void handleEndpoint_UnknownEndpoint() {
        ...
        assertThrows(NonExistentEntityException.class, () ->
                subtasksHandler.handleEndpoint(mockExchange, Endpoint.UNKNOWN, new String[]{"subtasks"}));
    }
    ...
    void parseSubtaskFromRequest_ShouldReturnSubtask() throws IOException {
        ...
        SubTask actualSubTask = subtasksHandler.parseSubtaskFromRequest(mockExchange);
        ...
        assertEquals(expectedSubTask.getParentId(), actualSubTask.getParentId());
    }
    ...
    void getId_ShouldThrowOnInvalidId() {
        ...
        assertThrows(NumberFormatException.class, () -> subtasksHandler.getId(pathParts));
    }
}
